...
module "app1" {
  ...
  ip_restrictions = [
    { name = "allow-ip", action = "Allow", ip_address = "18.153.146.156/32", service_tag = null, "priority" : 100 },
    { name = "allow-tm", action = "Allow", service_tag = "AzureTrafficManager", ip_address = null, "priority" : 110 },
